...
export default function WodPlanner() {
  ...
  const handleGenerateWod = async () => {
    ...
    const prompt = `Eres un Entrenador de CrossFit Certificado (Nivel 3/4) experto en fisiología del deporte y periodización de mesociclos. Tu box cuenta con el siguiente catálogo de ejercicios técnicos oficiales: [${catalogNames}].
    ...
    Debes retornar un objeto JSON que siga EXACTAMENTE la siguiente estructura:
    {
      ...
      "warmup": {
        ...
        "descripcion": "Instrucciones detalladas de entrada en calor en español, enfocadas en movilidad y aproximación al WOD",
        "ejercicios": []
      },
      "strength": {
        "habilitado": true/false,
        "descripcion": "Instrucciones detalladas del trabajo de fuerza o habilidad técnica en español. Si está habilitado, incluye series, repeticiones y porcentajes sugeridos de RM.",
        "ejercicios": [
      ...
      "conditioning": {
        "habilitado": true/false,
        "descripcion": "Instrucciones completas del acondicionamiento (WOD principal) en español (ej: AMRAP, EMOM, RFT, Chipper, indicando tiempos, movimientos y pesos Rx).",
        "ejercicios": []
      },
      "midline": {
        "habilitado": true/false,
        "descripcion": "Instrucciones de core, estabilidad abdominal y accesorios en español",
        "ejercicios": []
      },
      "extra": {
        "habilitado": true/false,
        "descripcion": "Instrucciones de trabajo extra/cardio en español (si se seleccionó VO2 Max, diseña AQUÍ un entrenamiento específico e intenso de VO2 Max con máquinas o running, ej: intervalos de remo de 500m con tiempos de descanso idénticos Z5)",
        "ejercicios": []
      }
    }
